[ENGLISH](https://github.com/anjoy8/Admin.Core/blob/master/README-en.md) | [中文版](https://github.com/anjoy8/Admin.Core/blob/master/README.md)


![Logo](https://github.com/anjoy8/Admin.Core/blob/master/Admin.Core/wwwroot/logocore.png)
...
*********************************************************
# Tips: 
1. Admin.Core.FrameWork project is a simple implementation of generating files using T4 templates.
...
1, in the Admin.Core.Repository layer under the Sugar folder under the BaseDBConfig.cs, configure their own strings
``` 
...
```
2, in the Admin.Core.FrameWork layer of the dbhelper.ttinclude, configure their own strings
``` 
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/Admin.Core
