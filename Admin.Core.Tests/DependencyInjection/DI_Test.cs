...
using Admin.Core.Common.AppConfig;
using System.Text;
...
namespace Admin.Core.Tests
{
    public class DI_Test
    {
        ...
        public void DI_Connet_Test()
        {
            ...
            //var assemblysServices = Assembly.Load("Admin.Core.Services");
        ...
        public IContainer DICollections()
        {
            ...
            services.AddScoped<Admin.Core.Model.Models.DBSeed>();
            services.AddScoped<Admin.Core.Model.Models.MyContext>();
