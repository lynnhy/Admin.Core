...
namespace Admin.Core.Model.Models
{
    public class FrameSeed
    {
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Admin.Core.Model", "Admin.Core.Model.Models", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Admin.Core.IRepository", "Admin.Core.IRepository", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Admin.Core.IServices", "Admin.Core.IServices", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Admin.Core.Repository", "Admin.Core.Repository", tableNames, "");
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Admin.Core.Services", "Admin.Core.Services", tableNames, "");
                return true;
            }
            catch (Exception)
            {
...
using Admin.Core.Model.Models." + ConnId + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          string strInterface)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Admin.Core.IRepository." + ConnId + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          string strInterface)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Admin.Core.IRepository." + ConnId + @";
using Admin.Core.IServices." + ConnId + @";
using Admin.Core.Model.Models." + ConnId + @";
